...
<div class="container text-white">
	...
	<hr class="mt-2 mb-4" />
	<input type="text" id="userInput" class="w-full bg-bg_secondary rounded-md outline-none mb-4 leading-4 p-2" placeholder="Your browser's name..." value={Pasta.metadata.name}>
	<div id="text">
		<pre class="whitespace-pre-wrap font-font_primary">
